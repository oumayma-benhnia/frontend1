...
@Component({
  selector: 'app-categorie-materiel-create-admin',
  templateUrl: './categorie-materiel-create-admin.component.html'
})
export class CategorieMaterielCreateAdminComponent extends AbstractCreateController<CategorieMaterielDto, CategorieMaterielCriteria, CategorieMaterielService>  implements OnInit {

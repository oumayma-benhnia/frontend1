...
@Component({
  selector: 'app-type-projet-edit-admin',
  templateUrl: './type-projet-edit-admin.component.html'
})
export class TypeProjetEditAdminComponent extends AbstractEditController<TypeProjetDto, TypeProjetCriteria, TypeProjetService>   implements OnInit {

...
@Component({
  selector: 'app-ressource-edit-admin',
  templateUrl: './ressource-edit-admin.component.html'
})
export class RessourceEditAdminComponent extends AbstractEditController<RessourceDto, RessourceCriteria, RessourceService>   implements OnInit {

...
@Component({
  selector: 'app-facture-edit-admin',
  templateUrl: './facture-edit-admin.component.html'
})
export class FactureEditAdminComponent extends AbstractEditController<FactureDto, FactureCriteria, FactureService>   implements OnInit {
    ...
    public prepareEdit() {
        this.item.dateEmission = this.factureService.format(this.item.dateEmission);
        this.item.dateEcheance = this.factureService.format(this.item.dateEcheance);
    }
